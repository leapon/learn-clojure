...
The `home-routes` handler in the `my-luminus.routes.home` namespace
...
The `home-page` function will in turn call the `my-luminus.layout/render` function
...
The routes are aggregated and wrapped with middleware in the `my-luminus.handler` namespace:
...
Request middleware functions are located under the `my-luminus.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `my-luminus.dev-middleware` namespace found in
